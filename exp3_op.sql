...
('DBMS',301,2,'CSE',5,3,'DR. RASHMI'),
('EN',302,2,'CSE',5,3,'MR. KUNAL GUPTA'),
('BS',303,2,'CSE',5,3,'MS. PRERNA ARORA'),
('DS',304,2,'CSE',5,3,'MS. NEETU NARAYAN'),
('ML',305,2,'CSE',5,3,'MR. ROHITANSH');
...
-- Dump completed on 2022-09-30  0:42:36
